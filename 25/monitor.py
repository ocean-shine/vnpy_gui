...
from vnpy.trader.object import TickData, OrderData, CancelRequest
...
class MonitorCell(QtWidgets.QTableWidgetItem):
    ...
    def set_content(self, content: object) -> None:
        ...
        if type(content) in {float, int}:
            ...
            contents = content.strftime("%H:%M:%S")
...
class OrderMonitor(BaseMonitor):
    ...
    def insert_new_row(self, key: str, data: object) -> None:
        ...
        for column, field_name in enumerate(self.headers.values()):
            ...
            # 在单元格上缓存委托数据
            cell.setData(QtCore.Qt.UserRole, data)
    ...
    def cancel_order(self, cell: MonitorCell) -> None:
        """"""
        order: OrderData = cell.data(QtCore.Qt.UserRole)
